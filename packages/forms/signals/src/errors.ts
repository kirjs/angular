...
export const enum SignalFormsErrorCode {
  ...
  UNSUPPORTED_FEATURE = 1913,
  UNSUPPORTED_STATUS_CHANGE = 1914,
  UNSUPPORTED_VALIDATOR_MANIPULATION = 1915,
  UNSUPPORTED_SET_ERRORS = 1916,
  UNSUPPORTED_MARK_AS_PENDING = 1917,
}
